...
<head>
    ...
    <link rel="icon" href="${alfred}/resources/images/favicon6.ico">
...
<div style="display: none;padding: 20px" id="saveOrUpdateDiv">
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm" style="margin-right: 20px">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="type" placeholder="请输入图书分类" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="publishTime" id="publishTime" placeholder="请输入出版时间" autocomplete="off" class="layui-input">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate', 'upload'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${alfred}/book/findPage.action' //数据接口
            , title: '图书信息'//数据导出来的标题
...
//初始化高度，使得冻结行表体高度一致
        ...
        table.on('tool(newsTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                ...
                $.post("${alfred}/book/update.action", {id: data.id, isOpen: isOpen}, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
        ...
        function openBorrow(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $("#bookId").val(data.id);
                    url = "${alfred}/bookBorrow/save.action";
                }
            });
        }
